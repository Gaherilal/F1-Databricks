...
races_selected_df.write.mode("overwrite").partitionBy("race_year").parquet("/mnt/f1dlpaliwal/processed/races")
...
display(spark.read.parquet("/mnt/f1dlpaliwal/processed/races"))