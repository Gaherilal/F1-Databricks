...
driver_df = spark.read.json("/mnt/f1dlpaliwal/raw/drivers.json",schema=driver_schema,)
...
driver_final_df.write.mode("overwrite").parquet("/mnt/f1dlpaliwal/processed/drivers")
