...
# MAGIC LOCATION '/mnt/f1dlpaliwal/demo1'

# COMMAND ----------

results_df = spark.read \
.option("inferSchema", True) \
.json("/mnt/f1dlpaliwal/raw1/2021-03-28/results.json")
...
dbutils.fs.ls("/mnt/f1dlpaliwal/demo1")
...
results_df.write.format("delta").mode("overwrite").save("/mnt/f1dlpaliwal/demo1/results_external")
...
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/f1dlpaliwal/demo1/results_external'
...
results_external_df = spark.read.format("delta").load("/mnt/f1dlpaliwal/demo1/results_external")
...
deltaTable = DeltaTable.forPath(spark, "/mnt/f1dlpaliwal/demo1/results_managed")
...
.option("inferSchema", True) \
.json("/mnt/f1dlpaliwal/raw1/2021-03-28/drivers.json") \
.filter("driverId <= 10") \
...
deltaTable = DeltaTable.forPath(spark, "/mnt/f1dlpaliwal/demo1/drivers_merge")
